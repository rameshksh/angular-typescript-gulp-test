...
export function main()
{
    describe('Home view ', () =>
    {
        ...
        beforeEach(angular.mock.module('/dist/dev/app/views/home.html'));
        ...
        beforeEach(angular.mock.inject(function ($rootScope: ng.IRootScopeService, $controller, $injector, $templateCache, $compile)
        {
            ...
            var htmlString = $templateCache.get('/dist/dev/app/views/home.html');
            if (htmlString)
            {
            ...
            controller = new HomeCtrl(scope, null, null, null);
        }));
