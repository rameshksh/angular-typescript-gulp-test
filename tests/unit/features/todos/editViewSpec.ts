...
export function main()
{
    describe('Todo edit view ', () =>
    {
        ...
        beforeEach(angular.mock.module('/dist/dev/app/features/todo/edit.html'));
        ...
        beforeEach(angular.mock.inject(function ($rootScope: ng.IRootScopeService, $controller, $injector, $templateCache, $compile)
        {
            ...
            var htmlString = $templateCache.get('/dist/dev/app/features/todo/edit.html');
            if (htmlString)
            {
            ...
            controller = new TodoEditCtrl(scope, null, null, null);
        }));
